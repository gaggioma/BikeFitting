...
class PoseLandmarkerHelper(
    ...
    fun setListenerClass(poseLandmarkerHelperListener: LandmarkerListener){
    ...
    fun detectVideoFile(
        ...
        //Permit only video max 5s
        if(videoLengthMs != null && videoLengthMs > maxVideoLengthMs){
            throw  IllegalArgumentException(
                "Only video with $maxVideoLengthMs ms length are allowed.\r\n"+
                "Current length: $videoLengthMs ms"
            )
        }
        ...
        //TODO: processed list of images
        val processedImageList = mutableListOf<Bitmap>()
        ...
        for (i in 0..numberOfFrameToRead) {
            ...
            retriever
                ...
                ?.let { frame ->
                    ...
                    processedImageList.add(argb8888Frame)
        ...
        return if (didErrorOccurred) {
            ...
            ResultBundle(resultList, inferenceTimePerFrameMs, height, width, processedImageList)
        }
    }
